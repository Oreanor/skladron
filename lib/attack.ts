...
/**
 * Потолок одного налёта. Раньше стояло 300 из опасения за браузер защитника,
 * но замер показал другое: тысяча дронов — это 134 мкс на кадр симуляции при
 * бюджете кадра в 16 000. Так что предел не в движке, а в здравом смысле.
 */
export const MAX_RAID = 1000;
