...
const en: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "For every cell you burn down you get a {loot} cr bonus. The defender's insurance pays them {insureCell} cr per burnt cell — exactly the repair — plus {insureShare}% of what burned with it: goods and guns.",
...
const ru: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "За каждую сожжённую клетку тебе идёт премия {loot} кр. Защитнику страховая платит {insureCell} кр за клетку — ровно на ремонт — и ещё {insureShare}% от сгоревшего вместе с ней: товара и пушек.",
...
const es: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Por cada celda quemada recibes una prima de {loot} cr. Al defensor el seguro le paga {insureCell} cr por celda —justo la reparación— y el {insureShare}% de lo que ardió con ella: mercancía y cañones.",
...
const pt: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Por cada célula queimada recebes um prémio de {loot} cr. Ao defensor o seguro paga {insureCell} cr por célula — exatamente a reparação — e {insureShare}% do que ardeu com ela: mercadoria e canhões.",
...
const fr: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Pour chaque case brûlée tu touches une prime de {loot} cr. Le défenseur, lui, reçoit de son assurance {insureCell} cr par case — juste la réparation — et {insureShare} % de ce qui a brûlé avec : marchandise et canons.",
...
const de: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Für jedes abgebrannte Feld bekommst du eine Prämie von {loot} Cr. Dem Verteidiger zahlt die Versicherung {insureCell} Cr je Feld — genau die Reparatur — und {insureShare} % dessen, was mit verbrannt ist: Ware und Geschütze.",
...
const it: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Per ogni cella bruciata ricevi un premio di {loot} cr. Al difensore l’assicurazione paga {insureCell} cr per cella — esattamente la riparazione — e il {insureShare}% di ciò che è bruciato con essa: merce e cannoni.",
