...
const en: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "For every cell you burn down you get a {loot} cr bonus. The defender's insurance pays them {insureCell} cr per burnt cell and another {insureDepot} if goods were stored there.",
...
const ru: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "За каждую сожжённую клетку тебе идёт премия {loot} кр. Защитнику страховая платит {insureCell} кр за клетку и ещё {insureDepot}, если на ней лежал товар.",
...
const es: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Por cada celda quemada recibes una prima de {loot} cr. Al defensor el seguro le paga {insureCell} cr por celda y {insureDepot} más si allí había mercancía.",
...
const pt: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Por cada célula queimada recebes um prémio de {loot} cr. Ao defensor o seguro paga {insureCell} cr por célula e mais {insureDepot} se lá estivesse mercadoria.",
...
const fr: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Pour chaque case brûlée tu touches une prime de {loot} cr. Le défenseur, lui, reçoit de son assurance {insureCell} cr par case et {insureDepot} de plus si de la marchandise y était stockée.",
...
const de: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Für jedes abgebrannte Feld bekommst du eine Prämie von {loot} Cr. Dem Verteidiger zahlt die Versicherung {insureCell} Cr je Feld und weitere {insureDepot}, wenn dort Ware lag.",
...
const it: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Per ogni cella bruciata ricevi un premio di {loot} cr. Al difensore l’assicurazione paga {insureCell} cr per cella e altri {insureDepot} se lì c’era merce.",
