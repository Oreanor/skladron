...
const en: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "«Sprinkler» — {spray} cr, placed and dragged just like a gun. It does not shoot: when a cell within {sprayRange} catches fire, the sprinkler spins up and sweeps eight jets of water around itself until the fire is out.",
...
const ru: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "«Огнетушитель» — {spray} кр, ставится и таскается так же, как пушка. Он не стреляет: как только в радиусе {sprayRange} клеток занимается огонь, установка раскручивается и бьёт восемью струями воды вокруг себя, пока не потушит.",
...
const es: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "«Extintor»: {spray} cr, se coloca y se arrastra igual que un cañón. No dispara: en cuanto arde una celda a menos de {sprayRange}, la instalación gira y lanza ocho chorros de agua a su alrededor hasta apagarla.",
...
const pt: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "«Extintor» — {spray} cr, coloca-se e arrasta-se tal como um canhão. Não dispara: assim que uma célula a menos de {sprayRange} pega fogo, a instalação gira e lança oito jactos de água à sua volta até apagar.",
...
const fr: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "« Extincteur » — {spray} cr, il se pose et se déplace comme un canon. Il ne tire pas : dès qu’une case s’enflamme à moins de {sprayRange}, l’installation se met à tourner et projette huit jets d’eau autour d’elle jusqu’à extinction.",
...
const de: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "«Löschanlage» — {spray} Cr, wird wie ein Geschütz gesetzt und gezogen. Sie schießt nicht: brennt ein Feld im Umkreis von {sprayRange}, dreht sie auf und schleudert acht Wasserstrahlen um sich, bis das Feuer aus ist.",
...
const it: RuleSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "«Estintore» — {spray} cr, si posa e si trascina come un cannone. Non spara: appena una cella entro {sprayRange} prende fuoco, l’impianto gira e lancia otto getti d’acqua attorno a sé finché non spegne.",
