...
const en = {
  ...
  "battle.seconds": "s",
  "raid.testQueued": "Test raids queued: {count} × {size} drones",
  "pattern.swarm": "Swarm",
  ...
  "pattern.rings": "Rings",
  "pattern.ringsHint": "5–10 rings from all around, ever more often",
  "pattern.spiral": "Spiral",
  "pattern.spiralHint": "the same rings, but spinning around the warehouse",
  "pattern.flower": "Flower",
  "pattern.flowerHint": "4–6 streams turning around the warehouse",
  "pattern.sweep": "Wiper",
  "pattern.sweepHint": "a dense stream sweeping back and forth",
  "edge.0": "top",
  "edge.1": "bottom",
  "edge.2": "left",
  "edge.3": "right",
...
const ru: Dict = {
  ...
  "battle.seconds": "c",
  "raid.testQueued": "Пробные налёты в очереди: {count} × {size} дронов",
  "pattern.swarm": "Рой",
  ...
  "pattern.rings": "Кольца",
  "pattern.ringsHint": "5–10 колец со всех сторон, всё чаще",
  "pattern.spiral": "Спираль",
  "pattern.spiralHint": "те же кольца, но закрученные вокруг склада",
  "pattern.flower": "Цветок",
  "pattern.flowerHint": "4–6 ручьёв, вращающихся вокруг склада",
  "pattern.sweep": "Метла",
  "pattern.sweepHint": "плотный ручей ходит туда-обратно",
  "edge.0": "сверху",
  "edge.1": "снизу",
  "edge.2": "слева",
  "edge.3": "справа",
...
const es: Dict = {
  ...
  "battle.creditsSuffix": "cr",
  "battle.seconds": "s",
  "raid.testQueued": "Ataques de prueba en cola: {count} × {size} drones",
  ...
  "pattern.ringsHint": "5–10 anillos desde todos lados, cada vez más seguidos",
  "pattern.spiral": "Espiral",
  "pattern.spiralHint": "los mismos anillos, girando alrededor del almacén",
  "pattern.flower": "Flor",
  "pattern.flowerHint": "4–6 chorros girando alrededor del almacén",
  "pattern.sweep": "Escoba",
  "pattern.sweepHint": "un chorro denso que va y viene",
  "edge.0": "arriba",
  "edge.1": "abajo",
  "edge.2": "izquierda",
  "edge.3": "derecha",
...
const pt: Dict = {
  ...
  "battle.creditsSuffix": "cr",
  "battle.seconds": "s",
  "raid.testQueued": "Ataques de teste na fila: {count} × {size} drones",
  ...
  "pattern.rings": "Anéis",
  "pattern.ringsHint": "5–10 anéis de todos os lados, cada vez mais seguidos",
  "pattern.spiral": "Espiral",
  "pattern.spiralHint": "os mesmos anéis, a girar à volta do armazém",
  "pattern.flower": "Flor",
  "pattern.flowerHint": "4–6 fluxos a girar à volta do armazém",
  "pattern.sweep": "Vassoura",
  "pattern.sweepHint": "um fluxo denso que vai e vem",
  "edge.0": "em cima",
  "edge.1": "em baixo",
  "edge.2": "à esquerda",
  "edge.3": "à direita",
...
const fr: Dict = {
  ...
  "battle.creditsSuffix": "cr",
  "battle.seconds": "s",
  "raid.testQueued": "Raids d’essai en file : {count} × {size} drones",
  ...
  "pattern.rings": "Anneaux",
  "pattern.ringsHint": "5 à 10 anneaux de tous côtés, de plus en plus serrés",
  "pattern.spiral": "Spirale",
  "pattern.spiralHint": "les mêmes anneaux, en tournant autour de l’entrepôt",
  "pattern.flower": "Fleur",
  "pattern.flowerHint": "4 à 6 flux tournant autour de l’entrepôt",
  "pattern.sweep": "Balai",
  "pattern.sweepHint": "un flux dense qui va et vient",
  "edge.0": "en haut",
  "edge.1": "en bas",
  "edge.2": "à gauche",
  "edge.3": "à droite",
...
const de: Dict = {
  ...
  "battle.creditsSuffix": "Cr",
  "battle.seconds": "s",
  "raid.testQueued": "Testangriffe in der Schlange: {count} × {size} Drohnen",
  ...
  "pattern.rings": "Ringe",
  "pattern.ringsHint": "5–10 Ringe von allen Seiten, immer dichter",
  "pattern.spiral": "Spirale",
  "pattern.spiralHint": "dieselben Ringe, nur um das Lager kreisend",
  "pattern.flower": "Blume",
  "pattern.flowerHint": "4–6 Ströme, die um das Lager kreisen",
  "pattern.sweep": "Wischer",
  "pattern.sweepHint": "ein dichter Strom hin und her",
  "edge.0": "oben",
  "edge.1": "unten",
  "edge.2": "links",
  "edge.3": "rechts",
...
const it: Dict = {
  ...
  "battle.creditsSuffix": "cr",
  "battle.seconds": "s",
  "raid.testQueued": "Incursioni di prova in coda: {count} × {size} droni",
  ...
  "pattern.rings": "Anelli",
  "pattern.ringsHint": "5–10 anelli da ogni lato, sempre più fitti",
  "pattern.spiral": "Spirale",
  "pattern.spiralHint": "gli stessi anelli, ma che ruotano attorno al magazzino",
  "pattern.flower": "Fiore",
  "pattern.flowerHint": "4–6 flussi che ruotano attorno al magazzino",
  "pattern.sweep": "Scopa",
  "pattern.sweepHint": "un flusso fitto che va e viene",
  "edge.0": "in alto",
  "edge.1": "in basso",
  "edge.2": "a sinistra",
  "edge.3": "a destra",
